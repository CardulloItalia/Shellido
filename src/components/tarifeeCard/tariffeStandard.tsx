...
export default function Tariffestandard() {
    return (
        <div className="flex flex-wrap gap-10 justify-center items-start ">
            {
                tariffeClient.giornalieri.map((tariffa) => (
                    <div key={tariffa.id}className="flex flex-col  w-fit gap-4 justify-center items-start border-2 border-[#2A6F97] rounded-md p-10">
